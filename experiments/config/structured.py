...
@dataclass
class PointDiffusionConfig(PointCloudDiffusionModelConfig):
    dim: int = 768
    depth: int = 4
    mlp_dim: int = 3072
    drop_rate: float = 0.1
...
cs.store(group='model', name='point_diffusion', node=PointDiffusionConfig)
